...
4. [Swagger Setup](#-4-swagger-setup)
5. [Global Error Handling (main.ts)](#-5-global-error-handling-maints)
6. [Multiple Database Concept](#-6-multiple-database-concept)
7. [Database Module Example](#-7-database-module-example)
8. [Example: Product Module](#-8-example-product-module)
9. [Auth From SELLER](#-9-auth-from-seller)
10. [Testing Suggestion](#-10-testing-suggestion)
11. [ENV Example](#-11-env-example)
